...
#echo "\33[1;36m   5)\33[1;37m  Introducir base de datos indicativos (actualizada 20-09-2019)"
echo ""
echo "\33[1;32m   ********************************************************************"
...
clear
            ...
            sudo apt-get update
            echo "${VERDE}"
            echo "A finalizado el update. Pulsa una tecla para continuar"
            read a
             echo "${AMARILLO}"
            sudo apt-get upgrade
            echo "${VERDE}"
            echo "A finalizado el upgrade. Pulsa una tecla para finalizar"
            read a
            echo ""
