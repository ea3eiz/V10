...
mode=`grep -n -m 1 "^Port=" $usuario/MMDVMHost/MMDVMDMR2YSF.ini`
buscar=":"
caracteres=`expr index $mode $buscar`
caracteres_linea=`expr $caracteres - 1`
numero_linea_port=`expr substr $mode 1 $caracteres_linea`
mode=$(awk "NR==$numero_linea_port" $usuario/MMDVMHost/MMDVMDMR2YSF.ini)
echo "$mode"

echo -n "\33[1;36m  10)\33[0m Modificar ID          - ${VERDE}"
idd=`grep -n "Id=" $usuario/MMDVMHost/MMDVMDMR2YSF.ini`
...
var100port= sed -n $linea2port  $usuario/MMDVMHost/MMDVMDMR2YSF.ini;

echo -n "\33[1;36m  13)\33[0m Modificar Password    - \33[1;33m"
pas=`grep -n '\<Password\>' $usuario/MMDVMHost/MMDVMDMR2YSF.ini`
pas1=`expr substr $pas 5 30`
echo "$pas1"

echo -n "\33[1;36m  14)\33[0m Modificar TXInvert    - \33[1;33m"
txinv=`grep -n '\<TXInvert\>' $usuario/MMDVMHost/MMDVMDMR2YSF.ini`
txinv1=`expr substr $txinv 4 30`
echo -n "$txinv1"

echo -n "\33[1;36m      a)\33[0m D-STAR      - \33[1;33m"
dstar=`grep -n "\[D-Star\]" $usuario/MMDVMHost/MMDVMDMR2YSF.ini` # devuelve ejem: 74:Enable=1
buscar=":"
...
presentar_valo= sed -n $numero_linea_dstar_letrap  $usuario/MMDVMHost/MMDVMDMR2YSF.ini; #presenta el valor en pantalla

echo -n "\33[1;36m  15)\33[0m Modificar RXLevel     - \33[1;33m"
rx=`grep -n '\<RXLevel\>' $usuario/MMDVMHost/MMDVMDMR2YSF.ini`
rx1=`expr substr $rx 4 30`
echo -n "$rx1"

echo -n "\33[1;36m      b)\33[0m DMR         - \33[1;33m"
dmr=`grep -n "\[DMR\]" $usuario/MMDVMHost/MMDVMDMR2YSF.ini` # devuelve ejem: 74:Enable=1
buscar=":"
...
presentar_valor= sed -n $numero_linea_dmr_letrap  $usuario/MMDVMHost/MMDVMDMR2YSF.ini; #presenta el valor en pantalla

echo -n "\33[1;36m  16)\33[0m Modificar TXLevel     - \33[1;33m"
tx=`grep -n -m 1 '\<TXLevel\>' $usuario/MMDVMHost/MMDVMDMR2YSF.ini`
tx1=`expr substr $tx 4 30`
echo -n "$tx1"

echo -n "\33[1;36m      c)\33[0m FUSION      - \33[1;33m"
fusion=`grep -n "LowDeviation" $usuario/MMDVMHost/MMDVMDMR2YSF.ini` # devuelve ejem: 74:Enable=1
buscar=":"
...
presentar_valor= sed -n $numero_linea_fusion_letrap  $usuario/MMDVMHost/MMDVMDMR2YSF.ini; #presenta el valor en pantalla

echo -n "\33[1;36m  17)\33[0m Modificar Duplex      - \33[1;33m"
dup=`grep -n -m 1 '\<Duplex\>' $usuario/MMDVMHost/MMDVMDMR2YSF.ini`
dup1=`expr substr $dup 3 30`
echo -n "$dup1"


echo -n "\33[1;36m        d)\33[0m P25         - \33[1;33m"
p25=`grep -n "\[P25\]" $usuario/MMDVMHost/MMDVMDMR2YSF.ini` # devuelve ejem: 74:Enable=1
buscar=":"
...
presentar_valor= sed -n $numero_linea_p25_letrap  $usuario/MMDVMHost/MMDVMDMR2YSF.ini; #presenta el valor en pantalla

echo -n "\33[1;36m  18)\33[0m Modificar TXHang      - \33[1;33m"
txh=`grep -n -m 1 '\<TXHang\>' $usuario/MMDVMHost/MMDVMDMR2YSF.ini`
txh1=`expr substr $txh 5 30`
echo -n "$txh1"

echo -n "\33[1;36m        e)\33[0m Baliza      - \33[1;33m"
cw= sed -n "31p"  $usuario/MMDVMHost/MMDVMDMR2YSF.ini; #presenta el valor en pantalla

echo -n "\33[1;36m  19)\33[0m Modificar Tramas      - \33[1;33m"
lg=`grep -n -m 1 '\<DisplayLevel\>' $usuario/MMDVMHost/MMDVMDMR2YSF.ini`
lg1=`expr substr $lg 4 30`
echo -n "$lg1"

echo -n "\33[1;36m  f)\33[0m RFModeHang  - \33[1;33m"
modehang=`grep -n -m 1 -c '\<RFModeHang\>' $usuario/MMDVMHost/MMDVMDMR2YSF.ini`
if [ $modehang = 0 ]; then
echo "\33[1;31mEsta versión MMDVMHost no trae este parámetro"
else
modehang=`grep -n -m 1 '\<RFModeHang\>' $usuario/MMDVMHost/MMDVMDMR2YSF.ini`
modehang1=`expr substr $modehang 3 30`
echo "$modehang1"
fi

echo -n "\33[1;36m  20)\33[0m Modificar Slot1       - \33[1;33m"
sl=`grep -n -m 1 '\<Slot1\>' $usuario/MMDVMHost/MMDVMDMR2YSF.ini`
sl1=`expr substr $sl 5 30`
echo -n "$sl1"

echo -n "\33[1;36m         g)\33[0m Timeout     - \33[1;33m"
timeo=`grep -n -m 1 -c '\<Timeout\>' $usuario/MMDVMHost/MMDVMDMR2YSF.ini`
if [ $timeo = 0 ]; then
echo "\33[1;31mEsta versión MMDVMHost no trae este parámetro"
else
timeo=`grep -n -m 1 '\<Timeout\>' $usuario/MMDVMHost/MMDVMDMR2YSF.ini`
timeo1=`expr substr $timeo 3 30`
echo "$timeo1"
fi

echo -n "\33[1;36m  21)\33[0m Tipo Pantalla Display - \33[1;33m"
Display=`grep -n -m 1 -c '\<Display\>' $usuario/MMDVMHost/MMDVMDMR2YSF.ini`
if [ $Display = 0 ]; then
echo "\33[1;31mEsta versión MMDVMHost no trae este parámetro"
else
Display=`grep -n -m 1 '\<Display\>' $usuario/MMDVMHost/MMDVMDMR2YSF.ini`
Display1=`expr substr $Display 3 30`
echo -n "$Display1"
fi

var=`grep -n -m 1 "\[Nextion\]" $usuario/MMDVMHost/MMDVMDMR2YSF.ini`
#var1=`grep -m 1 "\[Nextion\]" $usuario/MMDVMHost/MMDVMDMR2YSF.ini`
buscar=":"
largo_linea=`expr index $var $buscar`
largo_linea=`expr $largo_linea - 1`
numero_linea=`expr substr $var 1 $largo_linea`
numero_linea=`expr $numero_linea + 2` # y le suma uno qudando coomo: (75)
MODEMNEXTION=$(awk "NR==$numero_linea" $usuario/MMDVMHost/MMDVMDMR2YSF.ini)
letra=c
...
ScreenLayout=`grep -n -m 1 -c '\<ScreenLayout\>' $usuario/MMDVMHost/MMDVMDMR2YSF.ini`
if [ $ScreenLayout = 0 ]; then
echo "\33[1;31mEsta versión MMDVMHost no trae este parámetro"
else
ScreenLayout=`grep -n -m 1 '\<ScreenLayout\>' $usuario/MMDVMHost/MMDVMDMR2YSF.ini`
ScreenLayout1=`expr substr $ScreenLayout 5 30`
echo -n "$ScreenLayout1"
fi

var=`grep -n -m 1 "\[NXDN\]" $usuario/MMDVMHost/MMDVMDMR2YSF.ini`
buscar=":"
largo_linea=`expr index $var $buscar`
largo_linea=`expr $largo_linea - 1`
numero_linea=`expr substr $var 1 $largo_linea`
numero_linea=`expr $numero_linea + 1` # Se le suma 1 al número de linea
NXDN=$(awk "NR==$numero_linea" $usuario/MMDVMHost/MMDVMDMR2YSF.ini)
letra=c
...
Brightness=`grep -n -m 1 -c '\<Brightness\>' $usuario/MMDVMHost/MMDVMDMR2YSF.ini`
if [ $Brightness = 0 ]; then
echo "\33[1;31mEsta versión MMDVMHost no trae este parámetro"
else
Brightness=`grep -n -m 1 '\<Brightness\>' $usuario/MMDVMHost/MMDVMDMR2YSF.ini`
Brightness1=`expr substr $Brightness 5 30`
echo -n "$Brightness1"
fi

# j) POCSAG Enable=
var=`grep -n -m 1 "\[POCSAG\]" $usuario/MMDVMHost/MMDVMDMR2YSF.ini`
buscar=":"
largo_linea=`expr index $var $buscar`
largo_linea=`expr $largo_linea - 1`
numero_linea=`expr substr $var 1 $largo_linea`
numero_linea=`expr $numero_linea + 1` # Se le suma 1 al número de linea
POCSAG=$(awk "NR==$numero_linea" $usuario/MMDVMHost/MMDVMDMR2YSF.ini)
letra=c
...
lat=`grep -n "Latitude" $usuario/MMDVMHost/MMDVMDMR2YSF.ini`
lat1=`expr substr $lat 4 30`
echo "$lat1"

echo -n "\33[1;36m  25)\33[0m Coordenada Longitud   - \33[1;33m"
long=`grep -n "Longitude" $usuario/MMDVMHost/MMDVMDMR2YSF.ini`
long1=`expr substr $long 4 30`
echo "$long1"

echo -n "\33[1;36m  26)\33[0m Modulo D-STAR         - \33[1;33m"
modu=`grep -n -m 1 '\<Module\>' $usuario/MMDVMHost/MMDVMDMR2YSF.ini`
...
var300port= sed -n $linea22port  $usuario/MMDVMHost/MMDVMDMR2YSF.ini;

echo ""
echo "\33[1;36m  28)\33[1;33m Abrir fichero MMDVMDMR2YSF.ini para hacer cualquier cambio\33[1;33m"

echo ""
var1=`grep -n "\[DMR Network\]" $usuario/MMDVMHost/MMDVMDMR2YSF.ini` # devuelve ejem: 138:Enable=1
...
presentar_valor= sed -n $numero_linea_p  $usuario/MMDVMHost/MMDVMDMR2YSF.ini; #presenta el valor en pantalla
echo ""
...
indicativo=`echo "$indicativo" | tr [:lower:] [:upper:]`
                    ...
                    sed -i "$linea Callsign=$indicativo" $usuario/MMDVMHost/MMDVMDMR2YSF.ini

                    sed -i "$linea Callsign=$indicativo" $usuario/DMR2YSF/DMR2YSF.ini

indi=$(awk "NR==2" $usuario/MMDVMHost/MMDVMDMR2YSF.ini)
...
echo "Valor actual del RXFrequency: \33[1;33m${rxf#*=}\33[1;37m"
           	          ...
           	          read -p 'Introduce RXFrequency:        ' var2
                          ...
                          case $actualizar in
			  [sS]* ) echo ""
                              sed -i "$linea RXFrequency=$var2" $usuario/MMDVMHost/MMDVMDMR2YSF.ini

frec=$(awk "NR==13" $usuario/MMDVMHost/MMDVMDMR2YSF.ini)
...
echo "Valor actual del TXFrequency: \33[1;33m${txf#*=}\33[1;37m"
           	          ...
           	          read -p 'Introduce TXFrequency:        ' var2
                          ...
                          case $actualizar in
			  [sS]* ) echo ""
                          sed -i "$linea TXFrequency=$var2" $usuario/MMDVMHost/MMDVMDMR2YSF.ini
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
echo "Valor de la Ciudad: \33[1;33m${loca#*=}\33[1;37m"
              ...
              sed -i "$linea Location=$loc1" $usuario/MMDVMHost/MMDVMDMR2YSF.ini
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
echo "Valor de  la  URL   Web: \33[1;33m${url#*=}\33[1;37m"
			  ...
			  ur1=`echo "$ur1" | tr -d '[[:space:]]'`
                          sed -i "$linea URL=$ur1" $usuario/MMDVMHost/MMDVMDMR2YSF.ini
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
do
			  ...
			  [sS]* ) echo ""
                          ...
                          sed -i "$numero_linea_port Port=/dev/ttyAMA0" $usuario/MMDVMHost/MMDVMDMR2YSF.ini
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
do
			  ...
			  [sS]* ) echo ""
                          letrac=c
                          numero_linea_port=$numero_linea_port$letrac
                          sed -i "$numero_linea_port Port=/dev/ttyACM0" $usuario/MMDVMHost/MMDVMDMR2YSF.ini
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
do
			  ...
			  [sS]* ) echo ""
                          letrac=c
                          numero_linea_port=$numero_linea_port$letrac
                          sed -i "$numero_linea_port Port=/dev/ttyACM1" $usuario/MMDVMHost/MMDVMDMR2YSF.ini
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
do                   
			  ...
			  [sS]* ) echo ""
                          letra1=c
                          numero_linea_port=$numero_linea_port$letrac
                          sed -i "$numero_linea_port Port=/dev/ttyUSB0" $usuario/MMDVMHost/MMDVMDMR2YSF.ini
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
echo "Valor  actual  del Id: \33[1;33m${idd#*=}\33[1;37m"
           	          read -p 'Introduce un ID válido ' miid
                          ...
                          sed -i "3c Id=$miid" $usuario/MMDVMHost/MMDVMDMR2YSF.ini
                          sed -i "$numero_linea_idd Id=$miid" $usuario/DMR2YSF/DMR2YSF.ini

                          ide=$(awk "NR==3" $usuario/MMDVMHost/MMDVMDMR2YSF.ini)
...
master1=`echo "$master1" | tr [:upper:] [:lower:]`
                          ...
                          sed -i "$linea_master Address=$master1" $usuario/MMDVMHost/MMDVMDMR2YSF.ini

master=$(awk "NR==139" $usuario/MMDVMHost/MMDVMDMR2YSF.ini)
...
do
        ...
        [sS]* ) echo ""
                          ...
                          sed -i "$linea4 Port=$miid" $usuario/MMDVMHost/MMDVMDMR2YSF.ini
        break;;
        [nN]* ) echo ""
        break;;
esac
...
echo "   Valor actual del Password: \33[1;33m${pas#*=}\33[1;37m"
           	          read -p '   Introduce el password que corresponda: ' pas1
                          ...
                          sed -i "$linea Password=$pas1" $usuario/MMDVMHost/MMDVMDMR2YSF.ini
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
echo "Valor  actual del  TXInvert: \33[1;33m${txinv#*=}\33[1;37m"
                         ...
                         if [ $largo = 3 ]
                          ...
                          case $actualizar in
			  [sS]* ) echo ""
                          sed -i "$linea TXInvert=$txinv1" $usuario/MMDVMHost/MMDVMDMR2YSF.ini
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
echo "Valor  actual  del  RXLevel : \33[1;33m${rx#*=}\33[1;37m"
           	          read -p 'Valor óptimo para DVMEGA=45 : ' var2
                          ...
                          case $actualizar in
			  [sS]* ) echo ""
                          sed -i "$linea RXLevel=$var2" $usuario/MMDVMHost/MMDVMDMR2YSF.ini
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
echo "Valor  actual  del  TXLevel : \33[1;33m${tx#*=}\33[1;37m"
           	          read -p 'Valor óptimo para DVMEGA=50 : ' var2
                          ...
                          case $actualizar in
			  [sS]* ) echo ""
                          sed -i "$linea TXLevel=$var2" $usuario/MMDVMHost/MMDVMDMR2YSF.ini
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
echo "Valor actual del Duplex: \33[1;33m${dup#*=}\33[1;37m"
           	          read -p 'Para un repetidor Duplex=1 Para un DVMEGA Duplex=0: ' dup1
                          ...
                          case $actualizar in
			  [sS]* ) echo ""
                          sed -i "$linea Duplex=$dup1" $usuario/MMDVMHost/MMDVMDMR2YSF.ini
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
echo "Valor actual del TXHang: \33[1;33m${txh#*=}\33[1;37m"
           	          read -p 'Para un repetidor TXHang=4 Para un DVMEGA TXHang=0: ' txh1
                          ...
                          case $actualizar in
			  [sS]* ) echo ""
                          sed -i "$linea TXHang=$txh1" $usuario/MMDVMHost/MMDVMDMR2YSF.ini
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
echo "Valor actual del DisplayLevel: \33[1;33m${lg#*=}\33[1;37m"
           	     read -p 'Para visualizar tramas seguidas introduce 1, para una sola trama introduce 2:' lg1
                          ...
                          case $actualizar in
			  [sS]* ) echo ""
                          sed -i "$linea DisplayLevel=$lg1" $usuario/MMDVMHost/MMDVMDMR2YSF.ini
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
while true
do
sl=`grep -n -m 1 -c '\<Slot1\>' $usuario/MMDVMHost/MMDVMDMR2YSF.ini`
if [ $sl = 0 ]; then
...
echo "Valor actual del Slot1=: \33[1;33m${sl#*=}\33[1;37m"
           	          read -p 'Para DVMEGA Modificar el valor del Slot1=0: ' V
			              ...
			              [sS]* ) echo ""
			              V=`echo "$V" | tr -d '[[:space:]]'`			  
                          sed -i "$linea Slot1=$V" $usuario/MMDVMHost/MMDVMDMR2YSF.ini             
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
echo "Valor actual del Display=: \33[1;33m${Display1#*=}\33[1;37m"
                    ...
                    [sS]* ) echo ""
                    V=`echo "$V" | tr -d '[[:space:]]'`       
                          sed -i "$linea Display=$V" $usuario/MMDVMHost/MMDVMDMR2YSF.ini             
        break;;
        [nN]* ) echo ""
        break;;
esac
...
echo "Valor actual del ScreenLayout=: \33[1;33m${ScreenLayout1#*=}\33[1;37m"
                    ...
                    [sS]* ) echo ""
                    V=`echo "$V" | tr -d '[[:space:]]'`       
                          sed -i "$linea ScreenLayout=$V" $usuario/MMDVMHost/MMDVMDMR2YSF.ini             
        break;;
        [nN]* ) echo ""
        break;;
esac
...
echo "Valor  actual  del Brightness : \33[1;33m${Brightness1#*=}\33[1;37m"
                    ...
                    [sS]* ) echo ""
                    V=`echo "$V" | tr -d '[[:space:]]'`       
                          sed -i "$linea Brightness=$V" $usuario/MMDVMHost/MMDVMDMR2YSF.ini             
        break;;
        [nN]* ) echo ""
        break;;
esac
...
modu1=`echo "$modu1" | tr [:lower:] [:upper:]`
                          ...
                          sed -i "$linea Module=$modu1" $usuario/MMDVMHost/MMDVMDMR2YSF.ini
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
do
                          ...
                          presenta_valor= sed -n $numero_linea_dstar_letrap  $usuario/MMDVMHost/MMDVMDMR2YSF.ini;
                          read -p 'Desactivado=0 Activado=1:  '   dmrac1
                          actualizar=S 
                          case $actualizar in
                          [sS]* ) echo ""
                          sed -i "$numero_linea_dstar_letrac Enable=$dmrac1" $usuario/MMDVMHost/MMDVMDMR2YSF.ini
                          break;;
                          [nN]* ) echo ""
                          break;;
esac
...
do
                          ...
                          presenta_valor= sed -n $numero_linea_dmr_letrap  $usuario/MMDVMHost/MMDVMDMR2YSF.ini;
           	              read -p 'Desactivado=0 Activado=1: '   dmrac1
                          actualizar=S 
                          case $actualizar in
			                    [sS]* ) echo ""
                          sed -i "$numero_linea_dmr_letrac Enable=$dmrac1" $usuario/MMDVMHost/MMDVMDMR2YSF.ini
			                    break;;
			                    [nN]* ) echo ""
			                    break;;
esac
...
do
                          ...
                          presenta_valor= sed -n $numero_linea_fusion_letrap  $usuario/MMDVMHost/MMDVMDMR2YSF.ini;
                          read -p 'Desactivado=0 Activado=1:  '   dmrac1
                          actualizar=S 
                          case $actualizar in
                          [sS]* ) echo ""
                          sed -i "$numero_linea_fusion_letrac Enable=$dmrac1" $usuario/MMDVMHost/MMDVMDMR2YSF.ini
                          break;;
                          [nN]* ) echo ""
                          break;;
esac
...
do
                          ...
                          presenta_valor= sed -n $numero_linea_p25_letrap  $usuario/MMDVMHost/MMDVMDMR2YSF.ini;
                          read -p 'Desactivado=0 Activado=1: '   dmrac1
                          actualizar=S 
                          case $actualizar in
                          [sS]* ) echo ""
                          sed -i "$numero_linea_p25_letrac Enable=$dmrac1" $usuario/MMDVMHost/MMDVMDMR2YSF.ini
                          break;;
                          [nN]* ) echo ""
                          break;;
esac
...
do
                      ...
                      case $actualizar in
                      [sS]* ) echo ""
                      sed -i "31c Enable=$baliza" $usuario/MMDVMHost/MMDVMDMR2YSF.ini
                      break;;
                      [nN]* ) echo ""
                      break;;
esac
...
echo "Valor actual del RFModeHang = : \33[1;33m${modehang1#*=}\33[1;37m"
                    ...
                    [sS]* ) echo ""
                    V=`echo "$V" | tr -d '[[:space:]]'`       
                          sed -i "$linea RFModeHang=$V" $usuario/MMDVMHost/MMDVMDMR2YSF.ini             
        break;;
        [nN]* ) echo ""
        break;;
esac
...
echo "Valor actual del Timeout = : \33[1;33m${timeo1#*=}\33[1;37m"
                    ...
                    [sS]* ) echo ""
                    V=`echo "$V" | tr -d '[[:space:]]'`       
                          sed -i "$linea Timeout=$V" $usuario/MMDVMHost/MMDVMDMR2YSF.ini             
        break;;
        [nN]* ) echo ""
        break;;
esac
...
echo "Valor del Port: \33[1;33m$MODEMNEXTION"
                          ...
                          case $actualizar in
                          [sS]* ) echo ""
                          sed -i "$linea_sed_MN Port=$lat1" $usuario/MMDVMHost/MMDVMDMR2YSF.ini
                          break;;
                          [nN]* ) echo ""
                          break;;
esac
...
echo "Valor actual NXDN: \33[1;33m$NXDN"
                          ...
                          case $actualizar in
                          [sS]* ) echo ""
                          sed -i "$linea_sed_NXDN Enable=$NXDN1" $usuario/MMDVMHost/MMDVMDMR2YSF.ini
                          break;;
                          [nN]* ) echo ""
                          break;;
esac
...
do
                          ...
                          case $actualizar in
                          [sS]* ) echo ""
                          sed -i "$linea_sed_POCSAG Enable=$POCSAG1" $usuario/MMDVMHost/MMDVMDMR2YSF.ini
                          break;;
                          [nN]* ) echo ""
                          break;;
esac
...
echo "Valor de la Latitud: \33[1;33m${lat#*=}\33[1;37m"
           	          read -p 'Introduce la Latitud ' lat1
                          ...
                          case $actualizar in
			  [sS]* ) echo ""
                          sed -i "$linea Latitude=$lat1" $usuario/MMDVMHost/MMDVMDMR2YSF.ini
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
echo "Valor de la Longitud: \33[1;33m${long#*=}\33[1;37m"
           	          read -p 'Introduce la Longitud ' long1
                          ...
                          case $actualizar in
			  [sS]* ) echo ""
                          sed -i "$linea Longitude=$long1" $usuario/MMDVMHost/MMDVMDMR2YSF.ini
			  break;;
			  [nN]* ) echo ""
			  break;;
esac
...
do
			  ...
			  [sS]* ) echo ""
			   read -p 'Intruduce reflector DMR+ al que se conectara (ej:4370) ' opcion
                          ...
                          sed -i "$linea4 Options=StartRef=$opcion;RelinkTime=10;" $usuario/MMDVMHost/MMDVMDMR2YSF.ini
			  break;;
			  [nN]* ) echo ""
			  letra1=c
                          linea4=$linea33port$letra1
			  sed -i "$linea4 #Options=StartRef=4370;RelinkTime=10;" $usuario/MMDVMHost/MMDVMDMR2YSF.ini
			  break;;
esac
done;;
28) echo ""
...
do
                              ...
                              case $actualizar in
			                        [sS]* ) echo ""
                              geany $usuario/MMDVMHost/MMDVMDMR2YSF.ini
			                        break;;
			                        [nN]* ) echo ""
			                        break;;
esac
...
do
                          ...
                          sed -i "$linea Local=$dmrac1" $usuario/MMDVMHost/MMDVMDMR2YSF.ini
