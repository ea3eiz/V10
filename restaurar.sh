...
indicativo=$(awk "NR==1" /home/pi/datos_dvswitch)          
...
id=$(awk "NR==3" /home/pi/datos_dvswitch)
...
id2=$(awk "NR==4" /home/pi/datos_dvswitch)
...
Latitude=$(awk "NR==5" /home/pi/datos_dvswitch)
...
Longitude=$(awk "NR==6" /home/pi/datos_dvswitch)
...
port=$(awk "NR==7" /home/pi/datos_dvswitch)
...
location=$(awk "NR==8" /home/pi/datos_dvswitch)
...
url=$(awk "NR==9" /home/pi/datos_dvswitch)
...
address_especial=$(awk "NR==2" /home/pi/datos_dvswitch)
sudo sed -i "70c $address_especial" /opt/MMDVM_Bridge/especial.ini

password_especial=$(awk "NR==10" /home/pi/datos_dvswitch)
sudo sed -i "74c $password_especial" /opt/MMDVM_Bridge/especial.ini

port_especial=$(awk "NR==11" /home/pi/datos_dvswitch)
sudo sed -i "71c $port_especial" /opt/MMDVM_Bridge/especial.ini

sala_fcs=$(awk "NR==12" /home/pi/datos_dvswitch)
...
sala_nxdn=$(awk "NR==13" /home/pi/datos_dvswitch)
